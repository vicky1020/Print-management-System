...
//Bootstrap
//head.js(base_url+"assets/js/bootstrap.js");
...
head.js(base_url+"assets/js/custom/scriptbreaker-multiple-accordion-1.js", function() {
    ...
    $(".topnav").accordionze({
        accordionze: true,
        speed: 500,
        closedSign: '<img src="'+base_url+'assets/img/plus.png">',
        openedSign: '<img src="'+base_url+'assets/img/minus.png">'
    });
...
head.js(base_url+"assets/js/slidebars/slidebars.min.js", base_url+"assets/js/jquery.easing.min.js", function() {
